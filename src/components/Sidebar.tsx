...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#fe2722] duration-300 ease-linear dark:bg-[#fe2722] lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link to="/dashboard">
          <p className={"text-[35px] text-white"}>AliExpress</p>
        </Link>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        to="/dashboard"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-red dark:hover:bg-meta-4 ${
                          pathname === '/dashboard' &&
                          'bg-red dark:bg-meta-4'
                        }`}
                        // onClick={(e) => {
                        //   e.preventDefault();
                        //   sidebarExpanded
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-red dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-red dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/dashboard/form-elements' ||
              ...
              <li>
                <Link
                  to="/dashboard/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-red dark:hover:bg-meta-4 ${
                    pathname.includes('tables') && 'bg-red dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  to="/dashboard/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-red dark:hover:bg-meta-4 ${
                    pathname.includes('chart') && 'bg-red dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
